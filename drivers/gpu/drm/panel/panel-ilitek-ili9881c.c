...
// GIP 1
	...
	ILI9881C_COMMAND_INSTR(0x36, 0x00),
	ILI9881C_COMMAND_INSTR(0x37, 0x00),
	ILI9881C_COMMAND_INSTR(0x38, 0x78), /* VDD1&2 toggle 1sec */
	ILI9881C_COMMAND_INSTR(0x39, 0x00),
	ILI9881C_COMMAND_INSTR(0x3a, 0x00),
	ILI9881C_COMMAND_INSTR(0x3b, 0x00),
	ILI9881C_COMMAND_INSTR(0x3c, 0x00),
...
// GIP 3
	ILI9881C_COMMAND_INSTR(0x5e, 0x00),
	ILI9881C_COMMAND_INSTR(0x5f, 0x0D), /* FW_GOUT_L1   STV2_ODD */
	ILI9881C_COMMAND_INSTR(0x60, 0x0D), /* FW_GOUT_L2 */
	ILI9881C_COMMAND_INSTR(0x61, 0x0C), /* FW_GOUT_L3 */
	ILI9881C_COMMAND_INSTR(0x62, 0x0C), /* FW_GOUT_L4   RESET_ODD */
	ILI9881C_COMMAND_INSTR(0x63, 0x0F), /* FW_GOUT_L5 */
	ILI9881C_COMMAND_INSTR(0x64, 0x0F), /* FW_GOUT_L6 */
	ILI9881C_COMMAND_INSTR(0x65, 0x0E), /* FW_GOUT_L7 */
	ILI9881C_COMMAND_INSTR(0x66, 0x0E), /* FW_GOUT_L8    CK11 */
	ILI9881C_COMMAND_INSTR(0x67, 0x08), /* FW_GOUT_L9    CK9 */
	ILI9881C_COMMAND_INSTR(0x68, 0x02), /* FW_GOUT_L10 */
	ILI9881C_COMMAND_INSTR(0x69, 0x02), /* FW_GOUT_L11   CK7 */
	ILI9881C_COMMAND_INSTR(0x6a, 0x02), /* FW_GOUT_L12   CK5 */
	ILI9881C_COMMAND_INSTR(0x6b, 0x02), /* FW_GOUT_L13 */
	ILI9881C_COMMAND_INSTR(0x6c, 0x02), /* FW_GOUT_L14   CK3 */
	ILI9881C_COMMAND_INSTR(0x6d, 0x02), /* FW_GOUT_L15   CK1 */
	ILI9881C_COMMAND_INSTR(0x6e, 0x02), /* FW_GOUT_L16   STV1_ODD */
	ILI9881C_COMMAND_INSTR(0x6f, 0x02), /* FW_GOUT_L17 */
	ILI9881C_COMMAND_INSTR(0x70, 0x14), /* FW_GOUT_L18 */
	ILI9881C_COMMAND_INSTR(0x71, 0x15), /* FW_GOUT_L19 */
	ILI9881C_COMMAND_INSTR(0x72, 0x06), /* FW_GOUT_L20 */
	ILI9881C_COMMAND_INSTR(0x73, 0x02), /* FW_GOUT_L21 */
	ILI9881C_COMMAND_INSTR(0x74, 0x02), /* FW_GOUT_L22 */

	ILI9881C_COMMAND_INSTR(0x75, 0x0D), /* BW_GOUT_L1   STV2_ODD */
	ILI9881C_COMMAND_INSTR(0x76, 0x0D), /* BW_GOUT_L2 */
	ILI9881C_COMMAND_INSTR(0x77, 0x0C), /* BW_GOUT_L3 */
	ILI9881C_COMMAND_INSTR(0x78, 0x0C), /* BW_GOUT_L4   RESET_ODD */
	ILI9881C_COMMAND_INSTR(0x79, 0x0F), /* BW_GOUT_L5 */
	ILI9881C_COMMAND_INSTR(0x7a, 0x0F), /* BW_GOUT_L6 */
	ILI9881C_COMMAND_INSTR(0x7b, 0x0E), /* BW_GOUT_L7 */
	ILI9881C_COMMAND_INSTR(0x7c, 0x0E), /* BW_GOUT_L8  CK11 */
	ILI9881C_COMMAND_INSTR(0x7d, 0x08), /* BW_GOUT_L9  CK9 */
	ILI9881C_COMMAND_INSTR(0x7e, 0x02), /* BW_GOUT_L10 */
	ILI9881C_COMMAND_INSTR(0x7f, 0x02), /* BW_GOUT_L11 CK7 */
	ILI9881C_COMMAND_INSTR(0x80, 0x02), /* BW_GOUT_L12 CK5 */
	ILI9881C_COMMAND_INSTR(0x81, 0x02), /* BW_GOUT_L13 */
	ILI9881C_COMMAND_INSTR(0x82, 0x02), /* BW_GOUT_L14 CK3 */
	ILI9881C_COMMAND_INSTR(0x83, 0x02), /* BW_GOUT_L15 CK1 */
	ILI9881C_COMMAND_INSTR(0x84, 0x02), /* BW_GOUT_L16 STV1_ODD */
	ILI9881C_COMMAND_INSTR(0x85, 0x02), /* BW_GOUT_L17 */
	ILI9881C_COMMAND_INSTR(0x86, 0x14), /* BW_GOUT_L18 */
	ILI9881C_COMMAND_INSTR(0x87, 0x15), /* BW_GOUT_L19 */
	ILI9881C_COMMAND_INSTR(0x88, 0x06), /* BW_GOUT_L20 */
	ILI9881C_COMMAND_INSTR(0x89, 0x02), /* BW_GOUT_L21 */
	ILI9881C_COMMAND_INSTR(0x8A, 0x02), /* BW_GOUT_L22 */

	ILI9881C_SWITCH_PAGE_INSTR(4),
	ILI9881C_COMMAND_INSTR(0x00, 0x80),
	ILI9881C_COMMAND_INSTR(0x6E, 0x3A), /* VGH clamp 18.00V */
	ILI9881C_COMMAND_INSTR(0x6F, 0x57), /* reg vcl + pumping ratio VGH=4x VGL=-3x */
	ILI9881C_COMMAND_INSTR(0x35, 0x1F),
	ILI9881C_COMMAND_INSTR(0x3A, 0x24),
	ILI9881C_COMMAND_INSTR(0x8D, 0x1F), /* VGL clamp -12.00V */
	ILI9881C_COMMAND_INSTR(0x87, 0xBA),
	ILI9881C_COMMAND_INSTR(0xB2, 0xD1),
	...
	ILI9881C_COMMAND_INSTR(0x53, 0x82), /* VCOM1 */
	ILI9881C_COMMAND_INSTR(0x55, 0x84), /* VCOM2 */
	ILI9881C_COMMAND_INSTR(0x50, 0x85), /* VREG1OUT=4.308V */
	ILI9881C_COMMAND_INSTR(0x51, 0x80), /* VREG2OUT=-4.308V */
	ILI9881C_COMMAND_INSTR(0x60, 0x10), /* SDT */
	ILI9881C_COMMAND_INSTR(0x62, 0x00),
	ILI9881C_COMMAND_INSTR(0x42, 0x55),

	ILI9881C_COMMAND_INSTR(0xA0, 0x0C), /* VP255 */
	ILI9881C_COMMAND_INSTR(0xA1, 0x16), /* VP251 */
	ILI9881C_COMMAND_INSTR(0xA2, 0x23), /* VP247 */
	ILI9881C_COMMAND_INSTR(0xA3, 0x12), /* VP243 */
	ILI9881C_COMMAND_INSTR(0xA4, 0x14), /* VP239 */
	ILI9881C_COMMAND_INSTR(0xA5, 0x27), /* VP231 */
	ILI9881C_COMMAND_INSTR(0xA6, 0x1C), /* VP219 */
	ILI9881C_COMMAND_INSTR(0xA7, 0x1D), /* VP203 */
	ILI9881C_COMMAND_INSTR(0xA8, 0x7E), /* VP175 */
	ILI9881C_COMMAND_INSTR(0xA9, 0x1D), /* VP144 */
	ILI9881C_COMMAND_INSTR(0xAA, 0x29), /* VP111 */
	ILI9881C_COMMAND_INSTR(0xAB, 0x6C), /* VP80 */
	ILI9881C_COMMAND_INSTR(0xAC, 0x19), /* VP52 */
	ILI9881C_COMMAND_INSTR(0xAD, 0x16), /* VP36 */
	ILI9881C_COMMAND_INSTR(0xAE, 0x49), /* VP24 */
	ILI9881C_COMMAND_INSTR(0xAF, 0x20), /* VP16 */
	ILI9881C_COMMAND_INSTR(0xB0, 0x27), /* VP12 */
	ILI9881C_COMMAND_INSTR(0xB1, 0x50), /* VP8 */
	ILI9881C_COMMAND_INSTR(0xB2, 0x64), /* VP4 */
	ILI9881C_COMMAND_INSTR(0xB3, 0x3F), /* VP0 */

	ILI9881C_COMMAND_INSTR(0xC0, 0x00), /* VN255 GAMMA N */
	ILI9881C_COMMAND_INSTR(0xC1, 0x16), /* VN251 */
	ILI9881C_COMMAND_INSTR(0xC2, 0x23), /* VN247 */
	ILI9881C_COMMAND_INSTR(0xC3, 0x12), /* VN243 */
	ILI9881C_COMMAND_INSTR(0xC4, 0x14), /* VN239 */
	ILI9881C_COMMAND_INSTR(0xC5, 0x27), /* VN231 */
	ILI9881C_COMMAND_INSTR(0xC6, 0x1C), /* VN219 */
	ILI9881C_COMMAND_INSTR(0xC7, 0x1D), /* VN203 */
	ILI9881C_COMMAND_INSTR(0xC8, 0x7F), /* VN175 */
	ILI9881C_COMMAND_INSTR(0xC9, 0x1D), /* VN144 */
	ILI9881C_COMMAND_INSTR(0xCA, 0x29), /* VN111 */
	ILI9881C_COMMAND_INSTR(0xCB, 0x6C), /* VN80 */
	ILI9881C_COMMAND_INSTR(0xCC, 0x19), /* VN52 */
	ILI9881C_COMMAND_INSTR(0xCD, 0x16), /* VN36 */
	ILI9881C_COMMAND_INSTR(0xCE, 0x49), /* VN24 */
	ILI9881C_COMMAND_INSTR(0xCF, 0x20), /* VN16 */
	ILI9881C_COMMAND_INSTR(0xD0, 0x27), /* VN12 */
	ILI9881C_COMMAND_INSTR(0xD1, 0x50), /* VN8 */
	ILI9881C_COMMAND_INSTR(0xD2, 0x64), /* VN4 */
	ILI9881C_COMMAND_INSTR(0xD3, 0x3F), /* VN0 */
